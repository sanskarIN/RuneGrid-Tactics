...
for (const contract of ["ReplayDiffCategory", "ReplayDiffEntry", "ReplayDiffFilterResult", "ReplayDiffFilter", "ReplayDiffFilterShortcut", "ReplayDiffFilterNavigator", "ReplayDiffFilterShortcutReference", "Filter", "Classify", "TryParseShortcut", "Previous", "Next", "AffectedTiles", "AffectedUnitIds"]) {
...
console.log(`Godot project structure, ${jsonFiles.length} JSON content files, advanced routing, replay determinism, diagnostics, inspection, timeline scrubbing, keyboard navigation, shortcut reference overlay, first-time onboarding, mismatch warnings, filtered diff markers, and keyboard filter cycling validated.`);
