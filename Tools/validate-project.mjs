...
for (const contract of ["ReplayMismatchExport", "ReplayMismatchExportLine", "ReplayMismatchExportBuilder", "ToJson", "ToCsv", "BuildFileName", "AffectedTiles", "AffectedUnits", "Differences"]) {
