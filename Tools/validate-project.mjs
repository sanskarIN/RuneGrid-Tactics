...
for (const control of ["OpenReplayInspector", "ShowReplayInspector", "DETERMINISM AUDIT", "PLAY TO END", "RESET INSPECTION", "TIMELINE", "PREVIOUS", "NEXT", "HSlider", "_Input", "KEYS ·", "KEYS · F1", "ReplayInspectorKeyBindings", "REPLAY INSPECTOR KEYS", "BuildReplayShortcutReferenceOverlay", "SHORTCUT REFERENCE", "Key.F1", "CloseReplayShortcutReference"]) {
...
console.log(`Godot project structure, ${jsonFiles.length} JSON content files, advanced routing, replay determinism, diagnostics, inspection, timeline scrubbing, keyboard navigation, and shortcut reference overlay validated.`);
