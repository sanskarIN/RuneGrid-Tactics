...
const required = ["project.godot", "RuneGrid.Tactics.csproj", "Scenes/Main.tscn", "Scripts/Godot/GameRoot.cs", "Scripts/Core/GameSession.cs", "Scripts/Core/ReplayPlayer.cs", "Scripts/Core/ReplayFingerprint.cs", "Scripts/Core/ReplayStateDiff.cs", "Scripts/Core/ReplayInspector.cs", "Scripts/Core/ReplayInspectorShortcuts.cs", "Scripts/Core/ReplayInspectorOnboarding.cs", "export_presets.cfg", "Tests/RuneGrid.Tactics.Pathfinding.Tests.csproj", "Tests/TacticalGridPathfindingTests.cs"];
...
console.log(`Godot project structure, ${jsonFiles.length} JSON content files, advanced routing, replay determinism, diagnostics, inspection, timeline scrubbing, keyboard navigation, shortcut reference overlay, first-time onboarding, and mismatch warnings validated.`);
