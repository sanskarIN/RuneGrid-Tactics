...
for (const contract of ["ReplayInspectorOnboarding", "HasSeenReplayInspectorIntro", "ShouldShowIntro", "DismissIntro"]) {
...
console.log(`Godot project structure, ${jsonFiles.length} JSON content files, advanced routing, replay determinism, diagnostics, inspection, timeline scrubbing, keyboard navigation, shortcut reference overlay, and first-time onboarding validated.`);
